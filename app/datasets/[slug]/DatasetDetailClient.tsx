...
export default function DatasetDetailClient({ dataset }: DatasetDetailClientProps) {
    ...
    return (
        <main className="min-h-screen pt-[130px] font-inter bg-[#F6F6F6] pb-24">
            <div className="max-w-[1280px] mx-auto px-8 flex flex-col gap-[48px]">
                {/* Header Section */}
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                        <div className="flex flex-col gap-4 max-w-3xl">
                            <h1 className="font-manrope font-normal text-[48px] lg:text-[60px] leading-[1.1] text-[#2F2F2F] tracking-[-2.4px]">
                                Track {dataset.title} live
                            </h1>
                            <p className="font-inter font-normal text-[18px] leading-[28px] text-[#5B5B5B]">
                ...
                {hasClickedUseData && (
                    <div className="bg-white rounded-[40px] p-8 lg:p-10 border-2 border-[#D1FC00] shadow-[0_8px_32px_-12px_rgba(209,252,0,0.3)] flex flex-col gap-8 transition-all animate-in slide-in-from-top-4">
                                ...
                                <div className="lg:w-[320px] shrink-0 bg-[#F6F6F6] p-8 rounded-[32px] flex flex-col justify-center">
                                    ...
                                    {limitReached ? (
                                        <div className="bg-red-50 border border-red-200 text-red-700 p-4 rounded-xl mb-6">
                                            ...
                                            <p className="font-inter text-[12px]">You have already generated 2 free connections. Please upgrade your plan to access more datasets.</p>
                                        </div>
                                    ) : (
                ...
                {/* Main Content Area */}
                <div className="bg-[#FFFFFF] rounded-[48px] p-[24px] sm:p-[40px] shadow-[0px_25px_50px_-12px_rgba(47,47,47,0.05)] border border-[#1C1917]/5 flex flex-col gap-[40px]">
                    <div className="flex flex-col gap-6">
