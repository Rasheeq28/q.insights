...
export default function SignInPage() {
    ...
    // Listen for auth state changes to redirect if already logged in or just verified
    // Also sync user if needed (optional redundancy if callback misses it)
    // useEffect(() => { ... }, []) - omitted for simplicity as callback handles it for Magic Link
